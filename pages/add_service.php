...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') !== 'POST') {
    try { $_SESSION['form_token_add_service'] = bin2hex(random_bytes(16)); }
    catch (Throwable $e) { $_SESSION['form_token_add_service'] = bin2hex(random_bytes(8)); }
}
...
<html lang="en">
<head>
    <meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Add New Service</title>
