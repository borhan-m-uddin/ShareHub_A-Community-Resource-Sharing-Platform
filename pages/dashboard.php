...
// Migrated from project root: dashboard.php
...
if (($_SESSION['role'] ?? '') === 'seeker') {
    header('Location: ' . site_href('pages/seeker_feed.php'));
    exit;
}
...
if (isset($conn) && $conn instanceof mysqli) {
    // Items count
    if ($st = $conn->prepare("SELECT COUNT(*) AS c FROM items")) {
        $st->execute();
        $res = $st->get_result();
        $kpis['total_items'] = (int)($res->fetch_assoc()['c'] ?? 0);
        $res->free();
        $st->close();
    }
    // Services count
    if ($st = $conn->prepare("SELECT COUNT(*) AS c FROM services")) {
        $st->execute();
        $res = $st->get_result();
        $kpis['total_services'] = (int)($res->fetch_assoc()['c'] ?? 0);
        $res->free();
        $st->close();
    }
    // Pending requests count
    if ($st = $conn->prepare("SELECT COUNT(*) AS c FROM requests WHERE status = 'pending'")) {
        $st->execute();
        $res = $st->get_result();
        $kpis['pending_requests'] = (int)($res->fetch_assoc()['c'] ?? 0);
        $res->free();
        $st->close();
    }
}
...
<body>
    ...
    <div class="wrapper">
        ...
        <div style="margin-top:16px;" class="grid grid-auto">
            <?php if (isset($_SESSION["role"]) && $_SESSION["role"] === "admin"): ?>
                ...
                <div class="card">
                    <div class="card-body" style="text-align:center;">
                        ...
                        <div style="font-size:1.3rem; font-weight:800; color:var(--primary);"><?php echo $kpis['total_items']; ?></div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body" style="text-align:center;">
                        <div style="font-weight:800;">Total Services</div>
                        <div style="font-size:1.3rem; font-weight:800; color:var(--primary);"><?php echo $kpis['total_services']; ?></div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body" style="text-align:center;">
                        <div style="font-weight:800;">Pending Requests</div>
                        <div class="status-pending" style="font-size:1.3rem;">&nbsp;<?php echo $kpis['pending_requests']; ?></div>
                    </div>
                </div>
            <?php endif; ?>
            <a class="card" href="<?php echo site_href('pages/profile.php'); ?>" style="text-decoration:none;">
                <div class="card-body"><b>👤 Manage Profile</b>
                    <p class="muted" style="margin-top:6px;">Update your info and settings</p>
                </div>
            </a>
            <a class="card" href="<?php echo site_href('pages/conversations.php'); ?>" style="text-decoration:none;">
                <div class="card-body"><b>💬 Messages</b>
                    <p class="muted" style="margin-top:6px;">Conversations and notifications</p>
                </div>
            </a>
            <a class="card" href="<?php echo site_href('pages/reviews.php'); ?>" style="text-decoration:none;">
                <div class="card-body"><b>⭐ Reviews & Ratings</b>
                    <p class="muted" style="margin-top:6px;">Your feedback and trust</p>
                </div>
            </a>

            <?php if (isset($_SESSION["role"]) && $_SESSION["role"] === "giver"): ?>
                <a class="card" href="<?php echo site_href('pages/add_item.php'); ?>" style="text-decoration:none;">
                    <div class="card-body"><b>➕ Add Item</b>
                        <p class="muted" style="margin-top:6px;">Share something new</p>
                    </div>
                </a>
                <a class="card" href="<?php echo site_href('pages/add_service.php'); ?>" style="text-decoration:none;">
                    <div class="card-body"><b>➕ Offer Service</b>
                        <p class="muted" style="margin-top:6px;">List a skill or help</p>
                    </div>
                </a>
                <a class="card" href="<?php echo site_href('pages/manage_items.php'); ?>" style="text-decoration:none;">
                    <div class="card-body"><b>📦 Manage Items</b>
                        <p class="muted" style="margin-top:6px;">Add, edit, and track your items</p>
                    </div>
                </a>
                <a class="card" href="<?php echo site_href('pages/manage_services.php'); ?>" style="text-decoration:none;">
                    <div class="card-body"><b>⚙️ Manage Services</b>
                        <p class="muted" style="margin-top:6px;">Offer and update your services</p>
                    </div>
                </a>
                <a class="card" href="<?php echo site_href('pages/manage_requests.php'); ?>" style="text-decoration:none;">
                    <div class="card-body"><b>📋 Incoming Requests</b>
                        <p class="muted" style="margin-top:6px;">Approve or decline requests</p>
                    </div>
                </a>
            <?php endif; ?>

            <?php if (isset($_SESSION["role"]) && $_SESSION["role"] === "seeker"): ?>
                <a class="card" href="<?php echo site_href('pages/seeker_feed.php?tab=items'); ?>" style="text-decoration:none;">
                    <div class="card-body"><b>🛍️ Browse Items</b>
                        <p class="muted" style="margin-top:6px;">Find items shared by neighbors</p>
                    </div>
                </a>
                <a class="card" href="<?php echo site_href('pages/seeker_feed.php?tab=services'); ?>" style="text-decoration:none;">
                    <div class="card-body"><b>⚙️ Browse Services</b>
                        <p class="muted" style="margin-top:6px;">Discover help and expertise</p>
                    </div>
                </a>
                <a class="card" href="<?php echo site_href('pages/my_requests.php'); ?>" style="text-decoration:none;">
                    <div class="card-body"><b>📝 My Requests</b>
                        <p class="muted" style="margin-top:6px;">Track your requests</p>
                    </div>
                </a>
            <?php endif; ?>
            ...
            <?php if (isset($_SESSION["role"]) && $_SESSION["role"] === "admin"): ?>
                ...
                <a class="card" href="<?php echo site_href('admin/panel.php'); ?>" style="text-decoration:none;">
                    <div class="card-body"><b>�️ Admin Panel</b>
                        <p style="margin-top:6px;color:#6b7280;">Go to Admin Panel</p>
                    </div>
                </a>
            <?php endif; ?>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if ($giver_items): foreach ($giver_items as $it): ?>
                            ...
                            <div class="muted">No items yet. <a href="<?php echo site_href('pages/add_item.php'); ?>">Add your first item →</a></div>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <div style="margin-top:10px;"><a href="<?php echo site_href('pages/manage_requests.php'); ?>" class="btn btn-default">Manage Requests →</a></div>
                    </div>
                </div>
            </div>
        <?php elseif ($role === 'seeker'): ?>
            <div class="card" style="margin-top:18px;">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <div style="margin-top:10px; display:flex; gap:8px;"><a href="<?php echo site_href('pages/seeker_feed.php?tab=items'); ?>" class="btn btn-default">Browse Items →</a></div>
                </div>
            </div>
            <div class="card" style="margin-top:16px;">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <div style="margin-top:10px; display:flex; gap:8px;"><a href="<?php echo site_href('pages/seeker_feed.php?tab=services'); ?>" class="btn btn-default">Browse Services →</a></div>
                </div>
            </div>
            <div class="card" style="margin-top:16px;">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <div style="margin-top:10px;"><a href="<?php echo site_href('pages/my_requests.php'); ?>" class="btn btn-default">View All Requests →</a></div>
                </div>
            </div>
        ...
        <div style="margin-top:18px; display:flex; gap:10px;">
            <a href="<?php echo site_href('pages/logout.php'); ?>" class="btn btn-danger">🚪 Sign Out</a>
        </div>
    </div>
